						...
						ListFooterComponent={() => (
							<View>
								<View>
                                    ...
                                    <Divider style={{justifyContent:'center',alignItems:'center',margin:10,borderRadius:10}} styleName="section-header">
								...
								<Button
									...
									color="white"
									backgroundColor={Colors.mainColor}
									containerViewStyle={{ borderRadius: 15,marginBottom:30 }}
									borderRadius={15}
