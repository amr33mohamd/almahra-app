		...
		if (this.state.login == '1' ) {
			...
			return (
				<View style={{
					...
					<Image
						style={{ flex: 1, height: '10%', width: '100%' }}
						resizeMode='cover'
					...
					<View style={{ flex: 0.7, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
						<View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
							<View style={{ flex: 1 }}>
								<Button
									...
									containerViewStyle={{ borderRadius: 15,									borderColor:Colors.mainColor,
																		borderWidth:1
 }}
									borderRadius={15}
						...
						<TouchableOpacity style={{ flex: 1, marginTop: 7 }}
							...
							<Text style={{ fontFamily: 'Droid Arabic Kufi', color: Colors.mainColor, marginTop: 10 }}>Forget password</Text>
						</TouchableOpacity>
					</View>
					...
					<View style={styles.signupButtonContainer}>
						<View style={{ flex: 1, marginBottom: 13, width: '100%' }}>
							<Button
								...
								backgroundColor={'white'}
								borderRadius={15}
								buttonStyle={{ padding: 10,borderColor:Colors.mainColor }}
								containerViewStyle={{
									marginLeft: 0,
